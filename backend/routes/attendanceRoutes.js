...
const { markAttendance, getAttendance, getStudentAttendance, deleteAttendance, getClassMonthSummary, getDailyAttendance } = require('../controllers/attendanceController');
